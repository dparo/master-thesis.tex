...
with their values, meaning and justification for their usage.
As a quick summary for this chapter, the parameters are set in such a way
that branching and cut generations are disabled.
The ng-sets is enabled and their size is raised as high as possible.
...
dual bounds as close as possible to the elementary bounds, and to
improve the obtained dual bound at the end of the root node resolution process.
