...
While the first two formulations won't be the primary focus of this thesis,
they are still essential to understand some necessary details.
In this thesis, we will predominantly concentrate our efforts
on the SP formulation, see later discussion in \cref{sec:branch-and-price}.
Before presenting each formulation, we first define some basic notation
