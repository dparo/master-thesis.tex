...
problems with profits (see \cite{dellamico1995, feillet2005a}),
...
a capacitated (accumulated demand in visiting customers)
tour (or circuit) starting from a common point called the depot,
...
The major contributions regarding the CPTP directly are \cite{jepsen2011, jepsen2014}, \dots.
