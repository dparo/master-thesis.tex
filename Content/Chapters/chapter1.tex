...
\begin{align}
	\min_{e} \quad z_\mt{ESPPRC}(e) & =  \sum_{(i, j) \in E_d} \Expr*{ \ExprCptpReducedCost{i}{j} } e_{ij} \label{eq:espprc-obj-function}                                                                                           \\
	                                ...
	                                & \ExprESPPEdgesWithin[S] \le |S| - 1                                                                  \qquad \forall S \subseteq V_d   \label{eq:esppr-cgsec-constraints}                      \\
	                                & e_{0i} + e_{iN} \le 1                                                                                \qquad \forall i \in V_0         \label{eq:espprc-cptp-binding}                          \\
	                                & e_{ij}                   \in \lbrace 0, 1 \rbrace                                                    \qquad \forall (i, j) \in E_d    \label{eq:espprc-e-mip-var-bounds}                      \\
\end{align}
