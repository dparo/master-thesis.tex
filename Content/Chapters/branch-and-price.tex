...
\subsection{Families of Cutting Planes}
\label{sec:families-of-cutting-planes}
...
For an introduction to cutting planes for BAP algorithms, see \textcite{desaulniers2011}.
...
Cutting-planes involving edge-flow variables only, are by nature
robust.
