...
and sink vertices and the concept of packing  and elementarity sets.
...
we've defined the resource consumption on the arcs (instead of on the vertices)
as $q_{ij} = \frac{q_{i} + q_{j}}{2} \quad \forall i, j \in V$.
