...
The CVRPLIB website is a fantastic online resource for the vehicle routing problem research community.
It contains interactive plots of many routing problems instances,
along with the exact solution found by operations research practitioners
over the years.
...
where \texttt{<N>} is the number of customers in the instance,
