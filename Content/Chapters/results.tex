...
We've generated new artificial instances from presented sets.
...
and the labeling algorithm respectively.
...
Define a scale factor $s \in R_+$, we generate new artificial instances
characterized by a new $Q^\prime \in R_+, k^\prime \in Z_+$ vehicle capacity
and number of vehicles respectively.
...
\mytodo{Tell about inflation of the CVRP instance vehicle capacity}
