...
To satisfactorily measure the competitiveness of a branch-an-cut pricer,
...
is an online database for the vehicle routing problems,
which contains, among other things,
many freely downloadable CVRP test instances.
This site is a very useful reference resource for all the practitioners interested in the VRP research domain.
It contains interactive plots of many routing problems instances,
along with the best known/optimal solution found by the researchers over the years.
...
instance set family (published in \cite{augerat1995}).
...
To evaluate the performance of our pricer we employed some of the most
historical and commonly known CVRP instances:
set A, B, P \parencite{augerat1995}, set E \parencite{christofides1969}, set M \parencite{christofides1979}.
Refer to the CVRPLIB website or to \textcite{uchoa2017} for more additional details
on how these instances were obtained by their corresponding authors.
