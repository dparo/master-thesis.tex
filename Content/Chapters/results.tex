...
The included labeling algorithm implements,
on top of an exact implementation,
also contains two heuristic stages implementations, see \textcite{sadykov2021a}.
