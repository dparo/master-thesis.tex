...
the ng-sets augmeentation whenever possible as to achieve a dual bound as close
as possible to the elementarity bound.
We've implemented a custom stubbed functor (i.e. a glorified callback) to solve the pricing problem.
