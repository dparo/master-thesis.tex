...
The performance metric ratio relative to a baseline is plotted on the X-axis.
...
We used performance profiles extensively
to compare the competitiveness of our proposed BAC-based pricer
to the RCSP dynamic programming algorithm used by \bapcod{} \parencite{pessoa2020generic}.
