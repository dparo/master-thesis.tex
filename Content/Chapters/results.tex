...
The \textit{CVRPLIB website} is a fantastic online database for VRP practitioners.
It contains interactive plots of many routing problems instances,
along with the best known/optimal solution found by the operations research community over the years.
