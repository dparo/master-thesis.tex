...
As a result, we totaled $70$ PPs from the E test-set,
$30$ from the F test set,
$210$ from the A test set,
$190$ from the B test set
and $240$ from the P test set
for each inflation scaling factor $s$.
