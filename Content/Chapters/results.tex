...
The second dumped file instead it contains a slighly modified TSPLIB95 file format,
which encodes a CPTP problem, by introducing in a dedicate \texttt{PROFIT_SECTION}
the dual variables that were extracted for this particular column generation iteration.

and we dump the dual variables of the SP $\pi \in R^N$
for each exact pricing invocation.
