\begin{table*}[thb]
	...
	\end{tabular}
	\caption{
		Table listing the employed instances of the set E for the empirical evaluation.
...
\begin{table*}[thb]
	...
	\end{tabular}
	\caption{
		Table listing the employed instances of the set F for the empirical evaluation.
...
\begin{table*}[thb]
	...
	\end{tabular}
	\caption{
		Table listing the employed instances of the set A for the empirical evaluation.
...
\begin{table*}[thb]
	...
	\end{tabular}
	\caption{
		Table listing the employed instances of the set B for the empirical evaluation.
...
\begin{table*}[thb]
	...
	\end{tabular}
	\caption{
		Table listing the employed instances of the set P for the empirical evaluation.
