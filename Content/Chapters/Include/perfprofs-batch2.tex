...
\newcommand{\PerfprofFigureCaptionTwo}[1]{
	Continuation of the empirical study on the \texttt{#1} test set from \cref{fig:perpfrofs-batch2-#1-part1} testing even further inflation scale factors: $s = 5, 8, 10 \text{ and } 20$.
}
