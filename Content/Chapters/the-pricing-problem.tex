...
\textcite{jepsen2014} proves that the polytope of teh CPTP
can be transformed to an instance of the polytope for the OP.
...
along with a directed symmetric IP formulation.
