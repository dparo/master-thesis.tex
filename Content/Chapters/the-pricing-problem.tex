...
where they propose and adapt many valid inequalities from related problems,
introduce a new family of inequalities (rounded multistar inequalities)
and finally discuss and implement their efficient separation.
...
proving that such approach could provide a good complement
to the dynamic programming algorithms.
In conclusion,
\textcite{jepsen2014}
show that there may be value in further developing branch-and-cut
frameworks for pricing within CVRP's column generation schemes.
