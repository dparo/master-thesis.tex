...
The \labelcref{itm:cptp-branch-and-cut-better-p3} is probably due to the fact
...
The associated SPPRC can then be solved efficiently in pseudo-polynomial time.
