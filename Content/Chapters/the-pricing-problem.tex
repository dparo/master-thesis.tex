...
\begin{enumerate}
	...
	\item \label{itm:cptp-branch-and-cut-better-p1} The branch-and-cut (BAC) algorithm
	      ...
	      Whereas, the the BAC algorithm solved instances with up to $800$ customers.
...
The \cref{itm:cptp-branch-and-cut-better-p3} is probably due to the fact
...
Despite their contribution ought to be revisited in light of recent advances on both sides,
...
If the weighted network of the ESPPCC contains no negative-cost cycles,
...
Two vertices of the network, $s = 0, t = N^\prime - 1$, represent the source and sink vertices.
...
We provide a formal mathematical formulation of the ESPPCC as an Integer Program (IP):
\begin{align}
