...
The ESPPRC asks for the determination of a shortest path on a weighted network
...
A special case of the ESPPRC is obtained when it can be proved that the underlying
network won't contain any negative cost cycles.
...
See the contributions of \textcite{beasley1989, dumitrescu2003improved, carlyle2008, muhandiramge2009simultaneous},
just to name a few.
...
and \textcite{jepsen2011,jepsen2014} to the CPTP (a special case of ESPPCC).
ESPRCC branch-and-cut algorithms have not been covered,
and this is probabably to the inherent difficulty in modeling time windows constraints within IP formulations,
...
Our presentation of the ESPPCC follows the one provided in \textcite{beasley1989, toth2002, toth2014},
