...
Second, their separation procedure can share the same separation procedure required
to separate the GSECs.
Thus reducing the implementation efforts requierd for their inclusion.
