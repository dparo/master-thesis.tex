...
This CPTP problem is easier to describe than the ESPPRC.
...
it is far less addressed in the literature.
...
\textcite{jepsen2014} study the problem in more details,
and readjusted many commonly known VRP's cutting-planes to the CPTP problem.
