...
\section{The Elementary Shortest Path Problem with Capacity Constraint}
...
since these change the structure and formulation of the basic ESPPCC problem.
...
subject to a single resource restriction characterized
...
\textbf{directed} symmetric network based ESPPC formulation
...
We can provide a formal mathematical formulation of the ESPPCC as:
\begin{align}
