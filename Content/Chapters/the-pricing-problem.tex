...
\begin{enumerate}
	...
	\item \label{itm:cptp-branch-and-cut-better-p3} The branch-and-cut framework had a tendency
	      ...
	      threshold.
\end{enumerate}
The result \cref{itm:cptp-branch-and-cut-better-p1} is obtained for standalone
CPTP solutions and thus may not be relevant for the context of pricing.
Result \cref{itm:cptp-branch-and-cut-better-p2} is of little-interest
in the context of pricing
since highly negative weights network are usually solved through heuristics regardless.
The result \cref{itm:cptp-branch-and-cut-better-p3}, which is not in favor for a
