...
increase as the route traverses a new edge or vertex.
Resource consumption bounds can be given at different level of scopes which
can be classified as: global, at the vertex level, or at the arc level.
...
In this chapter we will provide mathematical descriptions of
this problem by exploiting Integer Programming (IP).
