...
\textcite{agarwal1989}, was on of the very few first attempt in applying the SP formulation
through a column generation approach to the CVRP.
Later, \textcite{desrochers1992} proposes the dynamic programming
label setting algorithm, a major breakthrough in VRP research,
still employed today in modern BPC schemes, to efficiently solve
the pricing problem.
