...
extended to the generic CVRP in \textcite{fisher1995, gouveia1995, achutan1998},
and later developed and generalized in \textcite{letchford2002} for the CVRP.
...
The multistar inequality were then applied successfully within i a branch-and-cut framework
...
These new works based on branch-and-cut frameworks, showed that CVRP instances
with small number of customers (less than 100) proved
