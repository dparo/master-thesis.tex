...
Another approach to use the so-called compact (in the number of constraints) models that, make use of a polynomial number
...
A set of binary variables $x_{ek} \in \Set*{0, 1}, e = \Set*{i, j} \in E, k = 1, \dots, K$
now encode whether vehicle $k$ traverses edge $e$.
...
For more details on this formulation please refer to \textcite{toth2002}.
