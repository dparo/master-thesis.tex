...
\begin{equation}
	\bar{c_e} = c_e - \frac{\pi_i + \pi_j}{2} - \omega_e a_{ep}
\end{equation}
...
These rules may filter a good portion of the search-space.
...
Cutting-planes define directly in terms of arc-flow variables are by nature
robust.
