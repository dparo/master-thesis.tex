...
where \ref{eq:three-index-flow-obj-func} is the objective function to be minimized (i.e. the overall travel distance),
...
finally, constraint \ref{eq:three-index-flow-secs} are the TSP subtour elimination constraints and are used to avoid the formation of spurious unconnected subtours.
