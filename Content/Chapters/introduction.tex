...
The arc flows can be easily computed from the master problem:
...
\begin{equation}
    \sum_{p \in P} \sum_{e \in \delta(S)}  a_{ep} \lambda_p \ge \ceil*{\sum_{i \in S} q_i / Q}
\end{equation}
...
and thus solvable through a pseudo-polynomial algorithm \parencite{desrochers1992, irnich2005}.
...
may be seen as a softer, more versatile, and more dynamic form of $q$-routes
