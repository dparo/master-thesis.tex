...
we highly suggest the book "\citetitle{toth2014}" of \textcite{toth2014}.
...
\mytodo{Rewrite/Review this section.}
...
\Cref{sec:cvrp-mathematical-formulations} presents the CVRP formally
...
\Cref{sec:branch-and-price} presents the branch-and-price (BPC) algorithm
...
\Cref{sec:the-pricing-problem} presents and discusses the pricing sub-problem
through multiple mathematically rigorous integer programming models.
\Cref{sec:implementation-chapter} presents the implementation details of our proposed branch-and-cut pricer.
