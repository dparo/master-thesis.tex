...
The capacity constraints can also be easily extended to the SP formulation
thanks to $x_e$ mapping (see \textcite{baldacci2008})\inlinetodo{WTF???, strengthened capacity cuts are non robust...!}.
...
they can trivially be extended to a robust inequelity for the SP formulation:
...
(i) Strengthened Capacity Constraints (SCC) proposed in \textcite{baldacci2008}, which can be considered a
