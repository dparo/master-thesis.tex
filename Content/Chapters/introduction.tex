...
for the operational management of a cost-efficient planning process.
...
The ng-routes may be considered more efficient
due to their different definition of the cycles' length
which provive a better measure of a cycle's impact.
In ng-routes cycles's length are measured in terms of distances,
whereas in the $k$-cycle elimination they're measured
in terms of customers which not may be a right criterion \parencite{contardo2014}.
...
and the number of pricing iterations per column generation increases \parencite{toth2014}.
...
of the column generation algorithm (see \cite{dumerle1999, rousseau2007, pessoa2013, pessoa2018}).
...
have led to exact solutions of CVPR problems composed of
