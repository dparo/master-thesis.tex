...
and later generalized to the assymetric case in \cite{laporte1986}.

We assume that vehicles must visit at least two customers,
We define a set of binary variables $x_{ij}$ in \Set*{0, 1} to indicate if a vehicle traverses
