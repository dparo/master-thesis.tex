...
models.
We present: the two-index arc flow formulation presented in \textcite{toth2002},
the three-index arc flow formulation presented in \textcite{laporte1983, laporte1985, laporte1986},
and  the Set Partitioning (SP) formulation presented in \textcite{balinski1964}.
...
Unfortunately these compact formulations are known to provide consistently weaker relaxations.
