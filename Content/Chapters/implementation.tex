...
Our static IP model is based on the CPTP formulation
of \labelcref{eq:cptp-obj-function,eq:cptp-depot-part-of-tour-constraint,eq:cptp-resource-upper-bound-constraint,eq:cptp-flow-conservation-constraint,eq:cptp-gsec-constraints,eq:cptp-x-mip-var-bounds,eq:cptp-y-mip-var-bounds}
by disregarding the GSECs of \cref{eq:cptp-gsec-constraints}.
...
as described later in \cref{sec:impl-separation-techniques}.
