...
by improving the linear relaxation of the IP model.
...
Their separation must occur through an exact separation procedure
See later discussion in \cref{sec:impl-separation-techniques}.
