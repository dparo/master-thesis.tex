...
is a fundamental factor when evaluating the inclusion of a set of inequalities.
...
employed for the optimal separation of the GSECs inequalities
also as a sub-optimal (heuristic) separation of the RCC and GLM inequalities.
