...
This section describes the full static model that we've implemented,
which is based on the CPTP formulation of \labelcref{eq:cptp-obj-function,eq:cptp-depot-part-of-tour-constraint,eq:cptp-resource-upper-bound-constraint,eq:cptp-flow-conservation-constraint,eq:cptp-gsec-constraints,eq:cptp-x-mip-var-bounds,eq:cptp-y-mip-var-bounds}
...
the GSECs will be dynamically generated inserted during the running-time of the branch-and-cut algorithm
