...
For singletons instead we fix $c(i) = -1  \quad \forall i \in V_0 \mid y^\star_i = 0$.
...
\begin{algorithm}
	\caption{An algorithm for computing the majoconnected components through a Depth-First Search (DFS) traversal}
