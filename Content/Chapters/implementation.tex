...
Despite separation of some generic families of cutting-planes are already provided
from modern MIP optimizers such as CPLEX (see \cref{sec:introduction-to-cplex}),
