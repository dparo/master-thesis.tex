...
\begin{quote}
	...
	eration which is available in the CPLEX callable library \cite{jepsen2008}.
\end{quote}
...
\begin{quote}
	...
	iteration can influence the convergence and the time spent re-optimizing the LP-problem \cite{jepsen2008}.
\end{quote}
