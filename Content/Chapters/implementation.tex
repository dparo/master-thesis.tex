...
proposed originally for the TSP in \textcite{flood1956, croes1958} independentl.
...
Hence, it is trivial to readjust the TSP 2-OPT procedure to the CPTP problem.

Let $a, b \in p$ be two vertices visited in the current route.
Let $a_s, b_s \in p$ denote respectively the successor of $a$ and $b$ in the current route.
A 2-OPT exchange removes edges $(a, a_s)$, $(b, b_s)$
in favor of $(a, b)$, $(a_s, b_s)$
