...
A complete pseudo-code of the GSEC integral separation is provided in \cref{algo:gsec-integral-sep}.
...
By recalling the GSEC inequality as presented in Equation \eqref{eq:gsec-constraints}, and the discussion about separating fractional $S \subseteq V_0$ in \cref{sec:fractional-separation}, it is easy to see that given a fractional solution instance of the form $0 \le x^*_{ij} \le 1,\ 0 \le y^*_{i} \le 1$ we have that:
...
The complete pseudocode can be found in \cref{algo:gsec-frac-sep}.
